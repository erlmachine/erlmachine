...
%% 1. Do context analysis. What is at left? For regex only operators at left side available, for divide - only the values or the returned values from operators available;
